    ...
    static void processFile(File xmlFile) {
        ...
        for (int i = 0; i < list.getLength(); i++){
    		...
    		for (int k = 0; k < catList.length; k++){
    			...
    			categoryWriter.println(id+seperator+category);
    		}
    		...
    		if (n > 0){
    			...
    			for (int j = 0; j < n; j++){
    	    		...
    	    		bidderWriter.println(bidderID+seperator+bidderRating+seperator+bidderLatitude+seperator+bidderLongitude+seperator+bidderLocationName+seperator+bidderCountry);
    	    		bidsWriter.println(bidderID+seperator+time+seperator+id+seperator+amount);
    			}
    		}
    		...
    		sellerWriter.println(sellerID+seperator+sellerRating);
    		itemsWriter.println(id+seperator+name+seperator+currently+seperator+buyPrice+seperator+firstBid+seperator+numOfBids+seperator+latitude+seperator+longitude+seperator+locationName+seperator+country+seperator+start+seperator+end+seperator+sellerID+seperator+description);
        }
